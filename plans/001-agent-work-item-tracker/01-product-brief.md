...
- Headless client access through Cognito OAuth 2.0 `client_credentials`; dev E2E tests use a dedicated test app client, while deployed-agent secret delivery is deferred until after MVP.
